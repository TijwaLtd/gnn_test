...
class DFTProcessor:
    def __init__(self, dft_data_path, lmax: int = 3, num_basis: int = 16, cutoff: float = 6.2): #cutoff = 6.2 thats what we were using with edgeconv..
    ...
    def build_graph(
        ...
        unit_vecs = edge_vecs / edge_lengths.unsqueeze(-1)                    # [E,3]
        sh  = spherical_harmonics(self.edge_irreps, unit_vecs, True)          # [E,dim_sh]
